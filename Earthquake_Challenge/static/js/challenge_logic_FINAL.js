...
// 1. Add the layer groups.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();
let last30dayEarthquakes = new L.LayerGroup();

// 2. Add a reference to the tectonic plates group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tectonic Plates": tectonicPlates,
  "Major Earthquakes (Only)": majorEarthquakes,
  "Major Earthquakes - 30 days" : last30dayEarthquakes
};
...
}).addTo(last30dayEarthquakes);
// 8. Add the major earthquakes layer to the map.
last30dayEarthquakes.addTo(map);
// 9. Close the braces and parentheses for the major earthquake data.
});